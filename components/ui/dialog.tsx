  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-panel border border-border rounded-lg shadow-2xl shadow-black/50',
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 rounded-sm text-foreground-dim opacity-70 ring-offset-background transition-opacity hover:opacity-100 hover:text-foreground focus:outline-none focus:ring-1 focus:ring-accent">
        <X className="h-4 w-4" />
